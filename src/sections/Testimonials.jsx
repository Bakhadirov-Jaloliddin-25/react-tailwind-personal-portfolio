...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      <div
        className="absolute top-1/2 left-1/2 w-200
        h-200 bg-primary/5 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"
      />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200">
              ...
              <blockquote className="text-xl md:text-2xl font-medium leading-relaxed mb-8 pt-4 min-h-[10.600em] md:min-h-[5.540em]">
